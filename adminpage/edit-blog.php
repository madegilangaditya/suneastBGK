	...
	<div class="content-top">
		<div class="col-md-12 ">
			...
			<div class="grid-form">
				<?php 
					$id = $_GET['id'];
					$query = " SELECT * FROM tb_blog WHERE id_blog = $id";
				...
				<div class="grid-form1">
					...
					<form name="input_data" action="proses-edit-blog.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="exampleInputEmail1">Title</label>
							<input type="hidden" name="id" value="<?php echo $row['id_blog'] ?>">
						...
						<div class="form-group">
							...
							<textarea class="ckeditor" name="article"><?php echo $row['blog'] ?></textarea>
						</div>
						<div class="form-group">
