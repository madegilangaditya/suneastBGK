		...
		<div class="col-md-12 ">
			...
			<div class="grid-form">
				...
				<div class="grid-form1">
				 	<h3 id="forms-example" class="" style="margin-bottom: 0px;">Add page</h3>
					<form name="input_data" action="proses-edit-page.php" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<textarea class="ckeditor" name="article"><?php echo $row['article'] ?></textarea>
						</div>
						<div class="form-group">
